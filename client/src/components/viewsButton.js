        ...
        <div className="card flex flex-column align-items-center gap-3">
            ...
            <OverlayPanel ref={op} closeOnEscape className='max-w-full'>
                <DataTable value={mapTokenAccess} paginator rows={5} sortField="accessTime" sortOrder={-1}>
                    <Column header={translations?.name} field="doctorName" sortable />
                    <Column header={translations?.editProfile?.specialty} field="specialty" />
                    <Column header={translations?.accessTime} field="accessTime" sortable />
                </DataTable>
            </OverlayPanel>
        </div>
    );
